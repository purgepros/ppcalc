...
const LandingPage = ({ config, onZipValidated, onCustomQuoteClick, onInfoClick, onAlertsInfoClick }) => {
  ...
  // Reference for the new Savings Section
  ...
  const scrollToSavings = () => {
    savingsSectionRef.current?.scrollIntoView({ behavior: 'smooth', block: 'center' });
  };
    ...
    <div className="font-sans text-slate-900 leading-relaxed bg-white w-full">
      ...
      <section className="relative bg-[#1a1a1a] text-white py-24 px-4 overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative z-10 text-center">
          ...
          {/* PSYCHOLOGICAL TRIGGER BANNER - CLICKABLE */}
          <button 
            onClick={scrollToSavings}
            className="inline-block bg-red-600 hover:bg-red-700 text-white font-extrabold px-6 py-3 rounded-full uppercase tracking-wider text-sm md:text-base mb-8 shadow-[0_0_20px_rgba(220,38,38,0.6)] animate-pulse border-2 border-red-400 transform hover:scale-105 transition-all cursor-pointer group"
          >
            <div className="flex flex-col items-center">
                <span>⚠️ DO NOT Pay For Your First Cleanup. Get It FREE! (An OVER $99 Value)</span>
                <span className="text-[10px] md:text-xs font-medium opacity-90 mt-1 underline group-hover:text-red-100">Click to learn how &darr;</span>
            </div>
          </button>
      ...
      {/* --- NEW SAVINGS EXPLAINER SECTION --- */}
      <section ref={savingsSectionRef} className="py-20 bg-slate-900 text-white relative overflow-hidden">
        {/* Background Accents */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#38b6ff] opacity-10 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2"></div>
        ...
        <div className="container mx-auto max-w-5xl px-4 relative z-10">
            <div className="text-center mb-12">
                <h2 className="text-4xl md:text-5xl font-extrabold mb-4 leading-tight">
                    Your Savings <span className="text-[#38b6ff]">Explained</span>
                </h2>
                <p className="text-xl text-gray-300 font-medium">Why we waive the <span className="text-green-400 font-bold">$99.99+ Startup Fee</span> that others charge.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
                
                {/* COMPETITOR CARD */}
                <div className="bg-white/5 border border-white/10 p-8 rounded-2xl relative overflow-hidden backdrop-blur-sm">
                    ...
                    <ul className="space-y-6 text-gray-400">
                        <li className="flex items-start">
                            ...
                            <span>Most companies charge an <strong>"Initial Scoop Fee"</strong> ranging from <strong>$150 to $300+</strong>.</span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-red-500 mr-3 text-lg">✖</span>
                            <span>They bill you for every minute spent cleaning accumulated winter waste.</span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-red-500 mr-3 text-lg">✖</span>
                            <span>This often results in a massive <strong>$100+ bill</strong> on your very first visit.</span>
                        </li>
                    </ul>
                </div>

                {/* PURGE PROS CARD */}
                <div className="bg-white text-slate-900 p-8 rounded-2xl relative overflow-hidden shadow-[0_0_40px_rgba(56,182,255,0.2)] transform md:-translate-y-4 border-4 border-[#38b6ff]">
                    <div className="absolute top-0 right-0 bg-[#38b6ff] text-white text-xs font-bold px-4 py-1 rounded-bl-xl uppercase tracking-wider">
                        The Purge Pros Guarantee
                    </div>
                    ...
                    <ul className="space-y-6">
                        <li className="flex items-start">
                            ...
                            <span className="font-medium">With a subscription, <strong>we waive this fee 100%.</strong></span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-green-500 mr-3 text-xl">✔</span>
                            <span>Your initial cleanup is <strong>100% FREE</strong> when you sign up for recurring services.</span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-green-500 mr-3 text-xl">✔</span>
                            <span>We clear weeks of accumulation and reset your yard to zero—at <strong>NO COST</strong> to you.</span>
                        </li>
                    </ul>
                    <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                        <p className="text-sm font-bold text-red-600 uppercase tracking-wide animate-pulse">
                            Offer Ends Soon!
                        </p>
                    </div>
                </div>
            ...
            <div className="mt-12 text-center">
                ...
                <p className="mt-4 text-sm text-gray-500 italic">*Free Yard Reset applies to NEW Twice Weekly, Weekly and Bi-Weekly subscriptions only.</p>
            </div>
        </div>
      </section>
